...
var showAllStrategies = function showAllStrategies() {
  var strategies = document.querySelectorAll('.strategy__wrapper .strategy');
...
var getStrategiesWrapper = function getStrategiesWrapper() {
  var strategiesContainer = document.querySelector('.strategy__wrapper');
  strategiesContainer.innerHTML = null;
...
var addStrategyClickHandler = function addStrategyClickHandler() {
  document.querySelector('.strategy__wrapper').addEventListener('click', function (e) {
...
window.onload = function () {
  ...
  addTagsClickHandler(); //generate Base modal
...
/*!********************************!*\
  ...
  \********************************/
/*! namespace exports */
/*! export ArticleModal [provided] [no usage info] [missing usage info prevents renaming] */
/*! other exports [not provided] [no usage info] */
